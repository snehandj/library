...
function addRentABook(event) {
  ...
  if (!day || day < 1) {
    return toastify('Enter the date', (type = 'error'));
  }
  ...
  toastify('The book has been successfully rented');
...
function addUser() {
  ...
  if (!userFullName || !useGender)
    return toastify('Please do not leave empty fields.', 'error');
